...
MinionTriggeredCardTemplate::MinionTriggeredCardTemplate(int x, int y, const QString &name, int cost, int attack, int defense, const QString &desc, QWidget *parent) : CardTemplate(x, y, parent)
{
