...
EnchantmentADCardTemplate::EnchantmentADCardTemplate(int x, int y, const QString &name, const QString &desc, int cost, int attack, int defense, QWidget *parent) : CardTemplate(x, y, parent)
{
    ...
    attackLabel->setText(QString::fromStdString("+") + QString::number(attack));
    attackLabel->setAlignment(Qt::AlignLeft|Qt::AlignBottom);
    defenseLabel->setText(QString::fromStdString("+") + QString::number(defense));
